...
async function processAudioJob(job) {
  ...
  try {
    ...
    const summaryResult = await summarizationService.generateSummary(transcriptionResult.text);
...
console.log('🚀 Background worker started and ready to process jobs');
